...
SELECT customers.company_name, CONCAT(first_name, ' ', last_name) as customer
FROM orders
...
INNER JOIN categories ON products.category_id=categories.category_id AND category_name IN ('Dairy Products', 'Condiments')
